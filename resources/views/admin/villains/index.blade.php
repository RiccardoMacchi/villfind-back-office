        ...
        <div class="col-md-8">
            @if ($villain)
                ...
                <div class="card villain-card shadow-lg border-0">
                    ...
                    <div class="position-relative villain-image">
                        <img src="{{ $villain && $villain->image ? asset('storage/' . $villain->image) : asset('storage/default-image.png') }}"
            ...
            @else
                <div class="alert alert-info">
                    Non hai ancora creato un Villain. <a style="color: #007bff;"
                        href="{{ route('admin.villains.create') }}">Create one now!</a>
                </div>
            @endif
        </div>
    </div>
